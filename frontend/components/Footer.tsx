...
export function Footer() {
  ...
  return (
    <footer className="relative mt-6 overflow-hidden rounded-t-[34px] border-t border-slate-700 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-5 md:px-6 md:py-7 lg:px-8">
        ...
        <div className="mt-4 rounded-2xl border border-slate-600 bg-white/10 p-3 text-xs text-slate-200 shadow-sm backdrop-blur-sm md:mt-5 md:flex md:items-center md:justify-between">
