        ...
        >
          {primaryLinks.map(link => (
            <Link
              ...
              href={link.href}
              className={cn(
                "inline-flex items-center gap-1 whitespace-nowrap border-b-2 border-transparent py-1 transition-all hover:border-slate-900/40",
                pathname === link.href && "border-slate-900"
              )}
            >
              {link.label}
            </Link>
          ...
          <div className="relative">
            <button
              ...
              className={cn(
                "inline-flex items-center gap-1 whitespace-nowrap border-b-2 border-transparent py-1 transition-all hover:border-slate-900/40",
                activeMenu === "convert" && "border-slate-900"
              )}
            >
              CONVERT PDF
            ...
            {activeMenu === "convert" && (
              <div className="absolute left-0 top-full mt-3 w-[300px] rounded-2xl border border-slate-200 bg-white p-3 shadow-xl">
          ...
          <div className="relative">
            <button
              ...
              className={cn(
                "inline-flex items-center gap-1 whitespace-nowrap border-b-2 border-transparent py-1 transition-all hover:border-slate-900/40",
                activeMenu === "all" && "border-slate-900"
              )}
            >
              ALL PDF TOOLS
            ...
            {activeMenu === "all" && (
              <div className="absolute right-0 top-full mt-3 w-[360px] rounded-2xl border border-slate-200 bg-white p-3 shadow-xl">
                <p className="px-2 pb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">
                  All Tools
                </p>
